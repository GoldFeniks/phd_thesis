...
%		\end{figure}
    ...
    \forpoi{%
    	\begin{frame}{Аппроксимация оператора квадратного корня}
    ...
    \forpoi{%
    	\begin{frame}{Принцип работы PML граничных условий}
    		\begin{figure}[h]
    			\centering
    ...
    \begin{frame}{Клиновидный волновод. Трассировка горизонт. лучей}
        \begin{block}{}
            \vspace{-0.5cm}
            \begin{equation}
        ...
        \begin{figure}[h]
            ...
            \caption{\small Сравнение трассировки лучей с использованием программы AMPLE (сплошная кривая) и численного интегрирования (пунктирная кривая) для первой распространяющейся моды}
        \end{figure}
    \end{frame}
    ...
    \forpoi{%
        \begin{frame}{Клиновидный волновод. Трассировка горизонт. лучей}
            \begin{figure}[h]
                ...
                \caption{\small Сравнение трассировки лучей с использованием программы AMPLE (сплошная кривая) и численного интегрирования (пунктирная кривая) для второй распространяющейся моды}
            \end{figure}
        \end{frame}
    }
    ...
    \forpoi{%
        \begin{frame}{Клиновидный волновод. Трассировка горизонт. лучей}
            \begin{figure}[h]
                ...
                \caption{\small Сравнение трассировки лучей с использованием программы AMPLE (сплошная кривая) и численного интегрирования (пунктирная кривая) для третьей распространяющейся моды}
            \end{figure}
        \end{frame}
    }

    \begin{frame}{Клиновидный волновод. Импульсный сигнал}
        \begin{figure}[h]
            \centering
            \includegraphics[width=0.75\textwidth]{fig7.pdf}
            \caption{Сравнение спектров сигнала в точке приёма}
        \end{figure}
    \end{frame}
	...
	\begin{frame}{Моделирование шума одиночного судна}
		\begin{block}{Вычисляемые величины}
			\vskip -0.5cm
			\begin{gather}
    ...
    \begin{frame}{Методика моделирования}
        \begin{block}{}
            \begin{enumerate}
                \item Провести измерение эффективного спектра источника шума некоторого опорного судна, а также величины $E_{p,ddec}\pa{f_c,d_{CPA}}$ в ближайшей точке прохода
                \item Выполнить оптимизацию параметров среды согласно предложенному алгоритму
                \item Использовать полученные параметры среды при проведении моделирования в рассматриваемой акватории
            \end{enumerate}
        \end{block}
    \end{frame}

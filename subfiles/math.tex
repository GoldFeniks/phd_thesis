    ...
    \section{Математические методы}
        ...
        \subsection{Колебательные скорость и ускорение}
            ...
            \begin{align}
                ...
                \end{multlined}\\
                &\frac{\partial p}{\partial y}=\sum\limits_{i=1}^\infty e^{ik_{0,j}x}\frac{\partial}{\partial y}\pa{\mathcal{A}_j\varphi_j}=\sum\limits_{i=1}^\infty e^{ik_{0,j}x}\pa{\frac{\partial\mathcal{A}_j}{\partial y}\varphi_j+\frac{\partial\varphi_j}{\partial y}\mathcal{A}_j}\,,\\
                &\frac{\partial p}{\partial z}=\sum\limits_{i=1}^\infty e^{ik_{0,j}x}\frac{\partial}{\partial z}\pa{\mathcal{A}_j\varphi_j}=\sum\limits_{i=1}^\infty e^{ik_{0,j}x}\mathcal{A}_j\frac{\partial\varphi_j}{\partial z}\,.
            \end{align}

    ...
    \section{Математические методы}
        ...
        \subsection{Начальные условия}
            ...
            \subsubsection{Лучевые начальные условия}\label{sec::ray_starters}
                ...
                \par Так как значения функций $S_j\pa{x,y}$ и $M_j\pa{x,y}$ вычисляются лишь на небольшом расстоянии $x_0$ (несколько десятков метров), в большинстве случаев будет достаточно начального условия рассчитанного для однородной среды при $k_j\pa{x,y}\equiv k_{j,0}$. В таком случае получим
